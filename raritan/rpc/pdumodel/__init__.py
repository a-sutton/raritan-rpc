...
class Pole(Structure):
    idlType = "pdumodel.Pole:4.0.1"
    elements = ["label", "line", "nodeId", "voltage", "voltageLN", "current", "peakCurrent", "activePower", "reactivePower", "apparentPower", "powerFactor", "phaseAngle", "displacementPowerFactor", "activeEnergy", "apparentEnergy", "residualCurrent", "residualCurrentStatus"]

    def __init__(self, label, line, nodeId, voltage, voltageLN, current, peakCurrent, activePower, reactivePower, apparentPower, powerFactor, phaseAngle, displacementPowerFactor, activeEnergy, apparentEnergy, residualCurrent, residualCurrentStatus):
...
# interface
class Inlet(EDevice):
    idlType = "pdumodel.Inlet:2.0.1"

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Inlet_2_0_1.MetaData:1.0.0"
    ...
    class Sensors(Structure):
        idlType = "pdumodel.Inlet_2_0_1.Sensors:1.0.0"
    ...
    class Settings(Structure):
        idlType = "pdumodel.Inlet_2_0_1.Settings:1.0.0"
        elements = ["name"]
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_2_0_1.SettingsChangedEvent:1.0.0"
    ...
    class EnableStateChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_2_0_1.EnableStateChangedEvent:1.0.0"
...
class OverCurrentProtector(EDevice):
    idlType = "pdumodel.OverCurrentProtector:3.0.1"

    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.OverCurrentProtector_3_0_1.Type:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_1.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_1.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_1.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OverCurrentProtector_3_0_1.SettingsChangedEvent:1.0.0"
...
class Circuit(Interface):
    idlType = "pdumodel.Circuit:1.0.1"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.Circuit_1_0_1.Type:1.0.0"
    ...
    class Config(Structure):
        idlType = "pdumodel.Circuit_1_0_1.Config:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Circuit_1_0_1.Sensors:1.0.0"
    ...
    class PoleSettings(Structure):
        idlType = "pdumodel.Circuit_1_0_1.PoleSettings:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Circuit_1_0_1.Settings:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Circuit_1_0_1.SettingsChangedEvent:1.0.0"
...
class PowerMeter(Interface):
    idlType = "pdumodel.PowerMeter:1.1.2"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.PowerMeter_1_1_2.Type:1.0.0"
    ...
    # structure
    class Config(Structure):
        idlType = "pdumodel.PowerMeter_1_1_2.Config:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.PowerMeter_1_1_2.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.PowerMeter_1_1_2.Settings:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_1_1_2.SettingsChangedEvent:1.0.0"
    ...
    class EnergyPulseSettings(Structure):
        idlType = "pdumodel.PowerMeter_1_1_2.EnergyPulseSettings:1.0.0"
    ...
    class EnergyPulseSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_1_1_2.EnergyPulseSettingsChangedEvent:1.0.0"
...
class Panel(PowerMeter):
    idlType = "pdumodel.Panel:1.1.2"

    # enumeration
    class LabelingScheme(Enumeration):
        idlType = "pdumodel.Panel_1_1_2.LabelingScheme:1.0.0"
    ...
    class PanelSettings(Structure):
        idlType = "pdumodel.Panel_1_1_2.PanelSettings:1.0.0"
    ...
    class PanelSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_2.PanelSettingsChangedEvent:1.0.0"
    ...
    class CircuitCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_2.CircuitCreatedEvent:1.0.0"
    ...
    class CircuitDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_2.CircuitDeletedEvent:1.0.0"
...
class Outlet(EDevice):
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Outlet_2_1_1.MetaData:1.0.0"
    ...
    class PowerState(Enumeration):
        idlType = "pdumodel.Outlet_2_1_1.PowerState:1.0.0"
        values = ["PS_OFF", "PS_ON"]
    ...
    class LedState(Structure):
        idlType = "pdumodel.Outlet_2_1_1.LedState:1.0.0"
    ...
    class State(Structure):
        idlType = "pdumodel.Outlet_2_1_1.State:1.0.0"
    ...
    class StartupState(Enumeration):
        idlType = "pdumodel.Outlet_2_1_1.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Outlet_2_1_1.Settings:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Outlet_2_1_1.Sensors:1.0.0"
    ...
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_2_1_1.PowerControlEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Outlet_2_1_1.StateChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_2_1_1.SettingsChangedEvent:1.0.0"
...
class OverCurrentProtectorTripSensor(raritan.rpc.sensors.StateSensor):
    idlType = "pdumodel.OverCurrentProtectorTripSensor:1.0.0"

    # value object
    class TripStateChangedEvent(raritan.rpc.sensors.StateSensor.StateChangedEvent):
        idlType = "pdumodel.OverCurrentProtectorTripSensor.TripStateChangedEvent:1.0.0"
...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:4.1.2"

    ERR_INVALID_PARAM = 1

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_4_1_2.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_4_1_2.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_4_1_2.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_4_1_2.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_4_1_2.Settings:1.0.0"
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_4_1_2.OutletSequenceState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_4_1_2.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_4_1_2.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_4_1_2.OutletSequenceStateChangedEvent:1.0.0"
...
class PowerMeterController(Interface):
    idlType = "pdumodel.PowerMeterController:1.1.2"
    ...
    class ScanResult(Structure):
        idlType = "pdumodel.PowerMeterController_1_1_2.ScanResult:1.0.0"
    ...
    class PowerMeterCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_1_2.PowerMeterCreatedEvent:1.0.0"
    ...
    class PowerMeterDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent:1.0.0"
    ...
    class PanelCreatedEvent(PowerMeterCreatedEvent):
        idlType = "pdumodel.PowerMeterController_1_1_2.PanelCreatedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                ...
                # for pdumodel.PowerMeterController_1_1_2.PowerMeterCreatedEvent
                powerMeter = Interface.decode(json['powerMeter'], agent),
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
    ...
    class PanelDeletedEvent(PowerMeterDeletedEvent):
        idlType = "pdumodel.PowerMeterController_1_1_2.PanelDeletedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                panelSettings = raritan.rpc.pdumodel.Panel.PanelSettings.decode(json['panelSettings'], agent),
                # for pdumodel.PowerMeterController_1_1_2.PowerMeterDeletedEvent
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
                actUserName = json['actUserName'],
